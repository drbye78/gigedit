...
static std::string groupName(Settings::Group_t group) {
    switch (group) {
        ...
        case Settings::SAMPLE_PROPS: return "SampleProps";
...
Settings::Settings() : Glib::ObjectBase(typeid(Settings)),
    ...
    samplePropsWindowX(*this, SAMPLE_PROPS, "x", -1),
    samplePropsWindowY(*this, SAMPLE_PROPS, "y", -1),
    samplePropsWindowW(*this, SAMPLE_PROPS, "w", -1),
    samplePropsWindowH(*this, SAMPLE_PROPS, "h", -1),
    ...
    m_ignoreNotifies(false)
{
    ...
    m_intProps.push_back(&samplePropsWindowX);
    m_intProps.push_back(&samplePropsWindowY);
    m_intProps.push_back(&samplePropsWindowW);
    m_intProps.push_back(&samplePropsWindowH);
